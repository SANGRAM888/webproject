            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2018 BMW M5</strong>
                  </h5>
                  <h6 class="price-emi">
                    <span class="price">Rs: 1,35,00,000</span>
                    <br></br>
                    <span class="emiprice">
                      EMI Starts @ <span class="amt">Rs: 2,29,193.53</span>
                    </span>
                  </h6>
                </div>
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/bmw/ma2.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  <li>
                    <span class="icon q1" />
                    <span class="cntnt">
                      Vehicle Type <strong>Sports Sedan</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Engine <strong>4395 CC</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Transmission <strong>8-Speed M Steptronic</strong>
                    </span>
                  </li>
                  <li>
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Trans. <strong>8-Speed M Steptronic</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q5"></span>
