          ...
          <div class="container-inner">
            <div class="nameprices-crtfedmodelkmsfuel">
              <div class="name-prices">
                <h5>
                  <strong>1952 Jaguar Mark V</strong>
                </h5>
                <h6 class="price-emi">
                  <span class="price">Rs: 65,00,000</span>
                  <br></br>
                  <span class="emiprice">
                    EMI Starts @ <span class="amt">Rs: 1,10,459.05</span>
                  </span>
                </h6>
              </div>
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img  src="images/jag/a3.jpg" class="d-block w-100" alt="..." />
            ...
            <div class="cntnt-item summary">
              ...
              <ul class="cardetail-summary-list">
                ...
                <li>
                  ...
                  <span class="cntnt">
                    Registration Year <strong>1952</strong>
                  </span>
                </li>
                <li>
                  <span class="icon q3"></span>
                  <span class="cntnt">
                    Engine <strong>3485 CC</strong>
                  </span>
                </li>
                <li>
                  <span class="icon q4"></span>
                  <span class="cntnt">
                    Transmission <strong>4-Speed Manual </strong>
                  </span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="cntnt">
                    Manufacturing Year <strong>1952</strong>
                  </span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="cntnt">
                    Exterior Color <strong>Green &amp; black</strong>
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div class="cntnt-item summary">
              ...
              <ul class="cardetail-summary-list">
                ...
                <li>
                  <span class="icon q4"></span>
                  <span class="cntnt">
                    Trans. <strong>4-Speed Manual </strong>
                  </span>
                </li>
                <li>
                  <span class="icon q5"></span>
