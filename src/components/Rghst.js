            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2013 ROLLS-ROYCE GHOST</strong>
                  </h5>
                  <h6 class="price-emi">
                    <span class="price">Rs: 1,40,00,000</span>
                    <br></br>
                    <span class="emiprice">
                      EMI Starts @ <span class="amt">Rs: 2,27,193.53</span>
                    </span>
                  </h6>
                </div>
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/rolls/a1.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Registration Year <strong>2015</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q3"></span>
                    <span class="cntnt">
                      Engine <strong>6592 CC</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Manufacturing Year <strong>2015</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>12400</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>black &amp; white</strong>
                    </span>
                  </li>
                </ul>
              </div>
