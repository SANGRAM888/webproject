            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2015 PORSCHE 911 GT3</strong>
                  </h5>
                  <h6 class="price-emi">
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/porse/a1.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>24100</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>red &amp; silver</strong>
                    </span>
                  </li>
                </ul>
              </div>
