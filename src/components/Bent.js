            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2018 BENTLEY CONTINENTAL GT W12</strong>
                  </h5>
                  <h6 class="price-emi">
                    <span class="price">Rs: 3,75,00,000</span>
                    <br></br>
                    <span class="emiprice">
                      EMI Starts @ <span class="amt">Rs: 6,37,263.74</span>
                    </span>
                  </h6>
                </div>
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img  src="images/bent/c1.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  <li>
                    <span class="icon q1" />
                    <span class="cntnt">
                      Vehicle Type <strong>Sports Coupe</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q2"></span>
                    <span class="cntnt">
                      Registration Year <strong>2019</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q3"></span>
                    <span class="cntnt">
                      Engine <strong>5950 CC</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Transmission <strong>8-Speed AUTO </strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Seating Capacity <strong>2+2</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q9"></span>
                    <span class="cntnt">
                      Manufacturing Year <strong>2018</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>5200</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>Red &amp; White</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  <li>
                    <span class="icon q1" />
                    <span class="cntnt">
                      Vehicle Type <strong>Sports cu.</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q2"></span>
                    <span class="cntnt">
                      Reg. Year <strong>2019</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q3"></span>
                  ...
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Trans. <strong>8-Speed AUTO </strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q5"></span>
