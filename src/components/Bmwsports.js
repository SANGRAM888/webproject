            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2021 BMW 740LI M SPORT INDIVIDUAL</strong>
                  </h5>
                  <h6 class="price-emi">
                    <span class="price">Rs: 1,69,00,000</span>
                    <br></br>
                    <span class="emiprice">
                      EMI Starts @ <span class="amt">Rs: 2,87,193.53</span>
                    </span>
                  </h6>
                </div>
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img  src="images/bmw/a1.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Registration Year <strong>2021</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q3"></span>
                    <span class="cntnt">
                      Engine <strong>2998 CC</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Manufacturing Year <strong>2021</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>7600</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>Black &amp; blue</strong>
                    </span>
                  </li>
                </ul>
              </div>
