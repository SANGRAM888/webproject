            ...
            <div class="container-inner">
              <div class="nameprices-crtfedmodelkmsfuel">
                <div class="name-prices">
                  <h5>
                    <strong>2017 MCLAREN 570S COUPE</strong>
                  </h5>
                  <h6 class="price-emi">
                    <span class="price">Rs: 2,59,00,000</span>
                    <br></br>
                    <span class="emiprice">
                      EMI Starts @ <span class="amt">Rs: 4,40,136.53</span>
                    </span>
                  </h6>
                </div>
        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img  src="images/mc/a1.jpg" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Manufacturing Year <strong>2017</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>8000</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>orange &amp; black</strong>
                    </span>
                  </li>
                </ul>
              </div>
