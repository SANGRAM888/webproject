      ...
      <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img
              src="images/ford/l.png"
              alt=""
              width="50"
              height="38"
              class="d-inline-block align-text-bottom mx-3"
            />
            <span className="mb-0 h1">FORD</span>
          </a>
        </div>
      </nav>
      <hr class="featurette-divider" />

      <img src="images/ford/b.jpg" class="img-fluid" alt="..." />
                ...
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c1.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title">It's more than Inovation.</h4>
                      <p class="card-text">It's a Ford Mustang mach E.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c2.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title">Stylish. Just like you.</h4>
                      <p class="card-text">The all-new Ford Mustang 2022.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c3.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title">Made to win the day.</h4>
                      <p class="card-text">The Ford Ecosport.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-4 mb-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">The Ford Haecienda.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Learn more of ford</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c7.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title">My Ford. My Service.</h4>
                ...
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c8.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title">Own a car</h4>
                      <p class="card-text">
                        Find your dream car with ford cars.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c5.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title"> Ford me</h4>
                      <p class="card-text">
                        Experience what your Ford can really do - with Ford me.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img
                      class="img-fluid"
                      alt="100%x280"
                      src="images/ford/c6.jpg"
                    />
                    <div class="card-body">
                      <h4 class="card-title"> Help when you need it.</h4>
                      <p class="card-text">
                       Ford helps you everywhere.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="row-x featurette">
            <div class="col-md-7 ">
              ...
              <p class="lead">
                Key Specs .
                <ul>
                  <li>Mileage : (upto)21.01 kmpl</li>
                  <li>Engine : (upto)1498 cc</li>
                  <li> Transmission : Automatic/Manual</li>
                  <li> BHP : 120.53</li>
                   <li> Airbags : yes</li>
                </ul>
