        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active ">
              <img src=" images/maybach/c1.png" class="d-block w-100" alt="..." />
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Registration Year <strong>2009</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q3"></span>
                    <span class="cntnt">
                      Engine <strong>5513 CC</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Transmission <strong>5-Speed AUTO </strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Manufacturing Year <strong>2004</strong>
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span class="cntnt">
                      Kms done <strong>33971</strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q12"></span>
                    <span class="cntnt">
                      Exterior Color <strong>Red &amp; black</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div class="cntnt-item summary">
                ...
                <ul class="cardetail-summary-list">
                  ...
                  <li>
                    <span class="icon q4"></span>
                    <span class="cntnt">
                      Trans. <strong>5-Speed AUTO </strong>
                    </span>
                  </li>
                  <li>
                    <span class="icon q5"></span>
