    ...
    <nav class="navbar navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img
            src="images/tesla/l.jpg"
            alt=""
            width="50"
            height="38"
            class="d-inline-block align-text-bottom mx-3"
          />
          <span className="mb-0 h1">Tesla</span>
        </a>
      </div>
    </nav>
    <hr class="featurette-divider" />

    <img src="images/tesla/b.jpg" class="img-fluid" alt="..." />
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c1.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title">It's more than Inovation.</h4>
                    <p class="card-text">It's a Tesla .</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c2.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title">Stylish. Just like you.</h4>
                    <p class="card-text">The all-new Tesla Model s.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c3.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title">Made to win the day.</h4>
                    <p class="card-text">The Tesla Model 3.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">The Tesla Model Y.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">Learn more of tesla</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c7.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title">My tesla. My Service.</h4>
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c8.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title">Own a car</h4>
                    <p class="card-text">
                      Find your dream car with tesla cars.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c5.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title"> tesla me</h4>
                    <p class="card-text">
                      Experience what your tesla can really do - with tesla me.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img
                    class="img-fluid"
                    alt="100%x280"
                    src="images/tesla/c6.jpg"
                  />
                  <div class="card-body">
                    <h4 class="card-title"> Help when you need it.</h4>
                    <p class="card-text">
                     tesla helps you everywhere.
                    </p>
                  </div>
                </div>
              </div>
